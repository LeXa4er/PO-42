...
namespace yt_DesignUI
{
    ...
    public class ToggleSwitchStyle : Control
    {
        #region -- Свойства --
        ...
        public Color BackColorON { get; set; } = Color.SpringGreen;
        public Color BackColorOFF { get; set; } =  Color.Gray;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            Pen penToggleHolder = new Pen(Color.Black, 1.55f);
            Pen penToggle = new Pen(Color.Black, 2);
