...
{
    public partial class FormStyles : Component
    {
        #region -- Свойста --
        ...
        private Dictionary<fStyle, FormSets> StylesDictionary; // Словарь вида: <Стиль из набора, Объект стиля с параметрами>
        private FormSets CurrentStyle; // Актуальный стиль, класс с его параметрамы
        ...
        public FormStyles(IContainer container)
        {
            DefineStyles();
        ...
        {
            StylesDictionary = new Dictionary<fStyle, FormSets>();
        ...
        private void SaveNoneStyleConfig()
        {
            ...
            {
                FormSets NoneStyle = StylesDictionary[fStyle.None];
        ...
        private void SaveUserStyleConfig()
        {
            if (StylesDictionary.ContainsKey(fStyle.UserStyle) && StyleUsed == false)
            {
                ...
                FormSets UserStyle = StylesDictionary[fStyle.UserStyle];
        ...
        private void DrawStyle(Graphics graph)
        {
            ...
            if (Form.ControlBox == true)
            {
                ...
                graph.DrawRectangle(new Pen(btnCloseHovered ?  Color .Red  : Color.Transparent), rectBtnClose);
                graph.FillRectangle(new SolidBrush(btnCloseHovered ?  Color .Red  : Color.Transparent), rectBtnClose);
